$(document).ready(function () {
  ...
  let textLink = $(".mega-menu_socials_list").find(".text-link");
  ...
  tl.set(body, { overflow: "visible" }) // Disable scrolling when menu is open
    ...
    .to(megaMenu, { display: "flex", top: "0vh", duration: 0.5 }, "<0.3") // Animate navbar_mega-menu_wrap down by 100vh
    .to(megaMenuItem, {
      opacity: 1,
      duration: 0.5,
      top: "0rem",
    ...
    .to(megaMenuCmsRow, { opacity: 1, duration: 0.5, stagger: 0.25 }, "<0.2")
    .to(textLink, { opacity: 1, duration: 0.5, stagger: 0.25 }, "<0")
    .to(localesItem, { opacity: 1, duration: 0.5, stagger: 0.25 }, "<0.4");
